...
from utils.util import NUM_FOLD #5 cross validation
...
def parse_sim_file(filename):
    ...
    return sim_dict  # filename -> [0,1]  dublicate filename  has value1


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--car_cbor", type=str) # '/home/tingchen_fu/ConvDR/dataset/raw/cast19'
    ...
    # merge two documents and re-number TREC-CAR
    car_id_to_idx = {}
    car_idx_to_id = []
    ...
    out_raw_queries = open(out_raw_queries_file, "w") # /home/tingchen_fu/ConvDR/dataset/cast19/queries.raw.tsv
    out_manual_queries = open(out_manual_queries_file, "w") # /home/tingchen_fu/ConvDR/dataset/cast19/queries.manual.tsv
    ...
    topic_number_dict = {}
    data = []
    for group in raw_data: # /home/tingchen_fu/ConvDR/dataset/raw/cast19/evaluation_topics_v1.0.json
